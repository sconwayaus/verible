...
TEST(MixedIndentationRuleTest, AcceptsText) {
  const std::initializer_list<LintTestCase> kTestCases = {
      ...
      {"// Expects module port 'hello_world' to follow end with _i\n"
       "module port_name_suffix(input bit hello_world);  // verilog_lint: "
       "waive port-name-style\n"
       "endmodule\n"},
  };
