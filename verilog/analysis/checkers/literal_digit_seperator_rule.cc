...
#include "verilog/analysis/checkers/literal_digit_seperator_rule.h"
...
int digit_spacing, int min_digits_to_seperate, absl::string_view base) {

  absl::string_view literal = token.text();
  // std::string literal;
